...
const feautureTitle = document.querySelector('.feautures__title');
console.log(feautureTitle);
...
function setHeaderStyle(e) {
    ...
    const moment = headerHeight + 5;
    console.log(`title ${feautureTitle.getBoundingClientRect().top}`);
    console.log(`moment ${moment}`);
    if (feautureTitle.getBoundingClientRect().top <= moment) {
